import styles from './ProfileCompleted.module.scss'
...
export default function ProfileCompleted (){
    return (<div className={styles.profile_completed_container}>
        ...
        <div className={styles.text_container}>
            ...
            <p className={styles.text_body}>공통 관심사와 언어를 바탕으로 매칭이 진행됩니다</p>
            <p className={styles.text_body}>새 펜팔에게 첫 편지를 부칠 준비가 되셨나요?</p>
        </div>
        <Button variant='primary' size='lg' className={styles.start_btn}>시작하기</Button>
    </div>)
}